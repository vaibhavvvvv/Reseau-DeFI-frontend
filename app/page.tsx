...
export default function Home() {
  return (
    <div className="space-y-6 sm:px-1 lg:px-8 py-6">
      <div className="bg-[#F3EDE8] shadow-[-10px_10px_0_0_#000000] rounded-lg p-4 sm:p-6">
        ...
        <p className="text-gray-700 mt-2 text-sm sm:text-base">Manage your tokens with ease</p>
      </div>
